	...
	MainActivity.global=2;
		...
		// items= new ArrayList<Object>(getItems());
				  ...
				  //mListAdapter = new OEListAdapter(getActivity(),R.layout.qr_equip_item, items)
					...
					mListView.setAdapter(new ArrayAdapter<String>(getActivity(),R.layout.qr_equip_item, oehelper.qr_equip_name) 
					{			
						...
						public View getView(int position, View convertView, ViewGroup parent) 
						{
							...
							if (mView == null)
								mView = getActivity().getLayoutInflater().inflate(R.layout.qr_equip_item, parent, false);
