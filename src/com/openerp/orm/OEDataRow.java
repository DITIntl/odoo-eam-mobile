...
public class OEDataRow {
	...
	public String getString(String key) 
	{
		if (_data.containsKey(key) && _data.get(key) != null)
			...
			return "false";
	//	Log.d("arra......"+_data.get(key).toString(),"arr.......");
	...
	//edit....
	 ...
	 public void addAll(HashMap<String, Object> data) {
	    ...
	    public void addAll(OEDataRow row) {
	    ...
	    public Bundle getPrimaryBundleData() {
	        ...
	        bundle.putInt(OEColumn.ROW_ID, getInt(OEColumn.ROW_ID));
	        return bundle;
	    }
